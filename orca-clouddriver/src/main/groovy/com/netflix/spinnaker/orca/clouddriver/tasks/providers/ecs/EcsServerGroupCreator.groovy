...
class EcsServerGroupCreator implements ServerGroupCreator, DeploymentDetailsAware {
    ...
    if (operation.useTaskDefinitionArtifact) {
      if (operation.taskDefinitionArtifact) {
        ...
        if (operation.evaluateTaskDefinitionArtifactExpressions) {
          ...
          List<Map<Object, Object>> evaluatedArtifact = getSpelEvaluatedArtifact(unevaluatedArtifact, stage)

          operation.spelProcessedTaskDefinitionArtifact = evaluatedArtifact
          operation.evaluateTaskDefinitionArtifactExpressions = true
        }
      } else {
    ...
    if (artifact instanceof List) {
      return List.copyOf(
          objectMapper.convertValue(
              artifact, new TypeReference<List<Map<Object, Object>>>() {}))
    }
  ...
  private List<Map<Object, Object>> getSpelEvaluatedArtifact(
    ...
    List<Map<Object, Object>> evaluatedArtifact =
        (List<Map<Object, Object>>) processorResult.get("artifact")
    return List.copyOf(evaluatedArtifact)
  }
